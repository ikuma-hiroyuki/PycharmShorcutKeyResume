...
| 実行系         | 実行停止                           | プログラムの途中でも停止させる                               | Ctrl+F2        |                |      |
| フォーカス切替 | スイッチャーの表示                 | 移動先を選べるようになる。Ctrl+Tabを押すたびに移動。         | Ctrl+Tab       | Ctrl+Tab       |      |
